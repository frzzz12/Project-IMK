  ...
  <main class="main">
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <a href="courses.php" class="mb-2 mb-lg-0"><i class="fa-solid fa-arrow-left" style="font-size: 1.5rem;"></i></a>
      </div>
    </div><!-- End Page Title -->
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-10">
        ...
        <div class="courses-grid" data-aos="fade-up">
          <h4>Hasil pencarian untuk: <strong><?= htmlspecialchars($keyword); ?></strong></h4>
  <hr>
  ...
  <div class="row justify-content-center">
    ...
    <?php } else { ?>
      <div class="col-12 text-center">
        <p class="text-muted">Video tidak ditemukan.</p>
      </div>
    <?php } ?>
